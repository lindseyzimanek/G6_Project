<%@ Page Title="" Language="VB" MasterPageFile="~/Library/library.master" AutoEventWireup="false" CodeFile="newresource.aspx.vb" Inherits="librarian_newresource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="ds_materialtypes" runat="server" ConnectionString="<%$ ConnectionStrings:cs_slpl %>" SelectCommand="SELECT * FROM [slpl_resourcetypes]"></asp:SqlDataSource>
    <asp:SqlDataSource ID="ds_yesno" runat="server" ConnectionString="<%$ ConnectionStrings:cs_slpl %>" SelectCommand="SELECT * FROM [slpl.answer]"></asp:SqlDataSource>
    <br />
    <asp:FormView ID="fv_newresource" runat="server" DataKeyNames="MaterialID" DataSourceID="ds_materials" DefaultMode="Insert">
        <EditItemTemplate>
            </EditItemTemplate>
        <InsertItemTemplate>
            <table width="auto">
